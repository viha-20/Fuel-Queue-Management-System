...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Passenger[][]  fuelList = new Passenger[6][7];
        ...
        Main main = new Main();
        FuelQueue.array(fuelList);
        main.mainMenu(fuelList);
    }

    public static void mainMenu(Passenger[][] fuelList) throws IOException {
        while(true) {
            ...
            switch (choice1) {
                ...
                case "101", "VEQ":
                    ...
                    break;
                case "102", "ACQ":
                    FuelQueue.addCustomerQueue(fuelList);
                    break;
                case "103", "RCQ":
                    FuelQueue.removeCustomerQueue(fuelList);
                    break;
                case "104", "PCQ":
                    FuelQueue.removeServedCustomer(fuelList);
                    break;
                case "105", "VCS":
